...
PIPELINE_STAGES = [
    ...
    "train_decision_tree",
    "train_month_decision_tree_important_features",
    "train_month_decision_tree_randomized_search_cv",
    "train_month_decision_tree_randomized_search_with_important_features",
    "train_xgboost",  
