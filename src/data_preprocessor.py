...
class TrainingPipeline:
            ...
            while state["current_stage"] and state["success"]:
                match state["current_stage"]:
                    ...
                    case "train_decision_tree":
                        ...
                        dt_result = self.train_decision_tree(month_id)
                        ...
                        state["current_stage"] = "train_decision_tree_with_important_features"

                    case "train_decision_tree_with_important_features":
                        print(f"Training decision tree with important features for {month_id}...")
                        important_result = self.train_decision_tree_with_important_features(month_id, importance_threshold=IMPORTANCE_THRESHOLD)
    ...
    def train_decision_tree(self, month_id, max_depth=None, random_state=42):
        """
    ...
    def train_decision_tree_with_important_features(self, month_id, importance_threshold=IMPORTANCE_THRESHOLD, max_depth=None, random_state=42):
        """
    ...
    def train_xgboost_with_important_features(self, month_id, importance_threshold=IMPORTANCE_THRESHOLD, params=None, random_state=42):
        ...
        try:
            ...
            shap_result = self.analyze_model_with_shap(
                ...
                max_samples=1000,
                random_state=random_state,
                model_name="xgboost_important_features",
                baseline_data=train_df  # Use training data for better baseline calculation
            )
            
            if shap_result.get("success", False):
                print("SHAP analysis completed successfully for XGBoost Important Features model!")
                
                # Compare with standard importance if SHAP was successful
                if "shap_importance_path" in shap_result:
                    print("\n" + "-"*60)
                    print("COMPARISON: Standard vs SHAP Feature Importance (XGBoost Important Features)")
                    print("-"*60)
